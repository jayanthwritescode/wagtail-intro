# Generated by Django 6.0.3 on 2026-03-31 01:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='OpportunitySubmissionPage',
            fields=[
        ...
        migrations.CreateModel(
            name='OpportunitySubmissionFormField',
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='opportunities.opportunitysubmissionpage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
